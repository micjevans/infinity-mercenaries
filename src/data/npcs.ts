export type NumericAttribute = "cc" | "bs" | "ph" | "wip" | "arm" | "bts" | "vita";
  ...
  },
  {
    ...
    profiles: [
      ...
      },
      {
        ...
        sourceRange: "C5:K20",
        equipment: [],
        weapons: ["Killer Hacking Device", "Submachine Gun", "Cybermine", "CC Weapon"],
      ...
      },
      {
        ...
        weapons: ["Tactical Bow (+1 SD)", "DA CC Weapon (PS=5)", "Deployable Repeater"],
  ...
  },
  {
    ...
    profiles: [
      ...
      },
      {
        ...
        baseSkills: ["Dodge (+2\")", "Limited Cover", "Mimetism (-3)", "Sixth Sense"],
    ...
    profiles: [
      {
        ...
        weapons: splitList("Sniper Rifle, Spitfire, Combi Rifle, Living Turret (Disposable 3)"),
        priority: splitPriority("Combi > Spitfire > Sniper > Place Living Turret"),
      ...
      },
      {
        ...
        weapons: splitList("Spitfire, Combi Rifle, Living Turret (Disposable 3), CC Weapon, Chain Colt"),
        priority: splitPriority("CC > Chain Colt > Combi > Spitfire > Place Living Turret"),
      ...
      },
      {
        ...
        weapons: splitList("Spitfire, Combi Rifle, Living Turret (Disposable 3), Pheroware Tactics: Endgame"),
        priority: splitPriority("Combi > Spitfire > Endgame > Place Living Turret"),
      ...
      },
      {
        ...
        equipment: splitList("360 Visor, MSV1, Pheroware Tactics: Endgame, SymbioMate (Refreshed per Hide)"),
        baseSkills: splitBullets(
        ...
        weapons: splitList("Combi Rifle, CC Weapon (-3), Chain Rifle, QAZ Creature (Disposable 3)"),
        priority: splitPriority('CC > Berserk (Short Skill (4")) > Chain > Combi > Place QAZ'),
      ...
      },
      {
        ...
        weapons: splitList("Combi Rifle, CC Weapon, Chain Colt, Pheroware Tactics: Endgame"),
      ...
      },
      {
        ...
        equipment: splitList("360 Visor, MSV1, Dazer (ZoC is Difficult Terrain to enemies)"),
        baseSkills: splitBullets(
        ...
        weapons: splitList("Combi Rifle, Pheroware Tactics: Endgame, Living Repeater (Disposable 3)"),
      ...
      },
      {
        ...
        equipment: splitList("360 Visor, Pheroware Tactics: Endgame, ECM: CC (-3)"),
        baseSkills: splitBullets(
        ...
        weapons: splitList("CC Weapon (-6), Chain Rifle (+1B), QAZ Creature (Disposable 3)"),
        priority: splitPriority('CC > Berserk (Short Skill (6")) > Chain > QAZ'),
      ...
      },
      {
        ...
        weapons: splitList("CC Weapon (-3), Chain Rifle, QAZ Creature (Disposable 3), Pheroware Tactics: Endgame"),
        priority: splitPriority('CC > Berserk (Short Skill (6")) > Chain > Endgame > Place QAZ'),
      ...
      },
      {
        ...
        priority: splitPriority("CC > Sepsitor > Comms > Camoflauge > Place Living Repeater (Doesn't break camo)"),
        traits: splitList("Defensive, Careful, Precise, Sneaky"),
        spawn:
      ...
      },
      {
        ...
        weapons: splitList("Pheroware Tactics: Endgame, Living Repeater (Disposable 3)"),
        priority: splitPriority("Comms > Camoflauge > Place Repeater (Doesn't break camo)"),
        traits: splitList("Defensive, Careful, Precise, Sneaky"),
        spawn:
